...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine(this.name + " " + wallet.money);
        }
        ...
        public bool TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            if (amountToTransfer <= wallet.money)
            {
                ...
                Console.WriteLine("Martha is sending $" + amountToTransfer + " to Donna");
                return true;
            }
            else
            {
                Console.WriteLine("Transfer could not be completed as the amount to transfer was greater than the amount in Martha's wallet.");
                return false;
            }
